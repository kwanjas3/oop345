...
bool validateItem(const string& ck) { // put this in utils
	if (ck.empty())
		return true;
	//for (auto chr : ck) {
...
bool validSequenceNumber(string& t) {
	if (t.empty())
		return true;
...
bool validCustomerName(const string& ck) { // put this in utils
	//for (auto chr : ck) {
	if (!isdigit(atoi(ck.c_str()))) return true;
	//return false;
	//}
...
bool validProductName(const string& ck) { // put this in utils
	//for (auto chr : ck) {
	if (!isdigit(atoi(ck.c_str()))) return true;
	//return false;
	//}
